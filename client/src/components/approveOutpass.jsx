  ...
  return (
    ...
    <div className="card">
        ...
        <div className="card-body">
            ...
            <p className="card-text"><span className='outpassTitle'>Reg. No:</span>20bcs070 </p>
        ...
        <ul className="list-group list-group-flush">
          ...
          <div className="choiceButtons">
            <Link to="" class="btn btn-success" target="_blank">Approve</Link>
            <Link to="" class="btn btn-danger" target="_blank">Decline</Link>
          </div>
    </div>
    </>
  )
